...
> extends HttpClient<SecurityDataType> {
  api = {
     ...
     * @tags Authentication
     * @name AddCustomer
     * @request POST:/api/Authentication/AddCustomer
     * @secure
     */
    addCustomer: (data: AddCustomerRequest, params: RequestParams = {}) =>
      this.request<AddCustomerResponse, string[]>({
        path: `/api/Authentication/AddCustomer`,
        method: "POST",
        body: data,
        secure: true,
